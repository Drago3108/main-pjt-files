                    ...
                    <div class="col-lg-6 text-right">
                        <ul class="top-header-optional">
                            ...
                            <li>
                                ...
                                <span><a href="my-account.php">Login</a> Or <a href="#">Register</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3">
                        <ul class="middle-header-optional">
                            ...
                            <li>
                                <a href="#"><i class="flaticon-shopping-cart"></i><span>2</span></a>
                            </li>
                            <li>$275.00</li>
                        </ul>
                    </div>
                        ...
                        <div class="collapse navbar-collapse mean-menu">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
								 ...
								 <li class="nav-item">
                                    <a href="my-account.php" class="nav-link">Account</a>
                                </li>
                            ...
                            <div class="others-option d-flex align-items-center">
                                <div class="option-item">
                                    <span>
                                        Hotline:
                                        <a href="tel:9962976521">(+91) 9962-976-521</a>
                                    </span>
                                </div>
                            </div>
                        </div>
